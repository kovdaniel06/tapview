...
<div className="absolute inset-0 rounded-[26px] bg-gradient-to-br from-blue-500/20 via-transparent to-indigo-600/10 pointer-events-none" />
<div className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-blue-500/25 blur-2xl pointer-events-none" />

{/* HEADER */}
<div className="relative z-10 flex items-center justify-between">
<div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-blue-500/20 border border-blue-400/30">
<TrendingUp className="h-4 w-4 text-blue-400" />
</div>
<span className="rounded-full border border-blue-400/35 bg-blue-500/20 px-2.5 py-1 text-[10px] font-bold text-blue-300 shadow-sm">
+324%
</span>
</div>
...
<Star key={i} className="h-3 w-3 shrink-0 fill-blue-400 text-blue-400" />
))}
</div>
